...
/*
 ...
 [8, 2, 9, 1, 4, 6, 7, 10] - [2, 4, 6, 7, 10] = [8, 9, 1] -> [1, 3, 4]
...
/// https://github.com/GeonHyeongKim/AlgoriGym/blob/master/Data%20structure/LIS.swift
///
...
for i in 0..<wireCount {
    var aInput = fileio.readInt()
    var bInput = fileio.readInt()
    arr.append((aInput, bInput))
}
...
lisWithBinarySearch(&bArr)

for i in 0..<lisArr.count {
    arr.removeAll(where: { $1 == lisArr[i]})
}
